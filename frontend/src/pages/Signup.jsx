...
export default function Signup() {
    ...
    async function handleSignup() {
        try{
            const res = await fetch("https://mern-paytm.vercel.app/api/v1/user/signup", {
                method: "POST",
                body: JSON.stringify({
                    username: username,
                    firstName: firstName,
        ...
        <div className="h-screen flex justify-center items-center bg-gray-200">
            <div className="rounded-2xl p-6 flex flex-col justify-center bg-white drop-shadow-lg">
                ...
                <div className="flex justify-center">
                    ...
                    <a href="https://mern-paytm-app.vercel.app/signin" className="underline hover:text-teal-400 cursor-pointer">Sign-in</a>
                </div>
            </div>
        </div>
    )
