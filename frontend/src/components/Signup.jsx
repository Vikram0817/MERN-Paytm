    ...
    return (
        <div className="h-screen flex justify-center items-center">
            <div className="border-2 border-black rounded-2xl p-6 flex flex-col justify-center">
                ...
                <input className="border-2 p-1 mb-2" type="text" value={firstName} onChange={e => setFirstName(e.target.value)}/>
                
                <label htmlFor="last-name">Last Name</label>
                <input className="border-2 p-1 mb-2" type="text" value={lastName} onChange={e => setLastName(e.target.value)}/>
                ...
                <div className="flex justify-center">
                    ...
                    <a className="underline hover:text-teal-400 cursor-pointer">Sign-in</a>
                </div>
            </div>
        </div>
    )
